...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **SDA_2020_St_Gallen_Bitcoin_Sentiment_Analysis_Using_Tweets** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
Description: 'Analysis of bitcoin fluctuations using sentiments from tweets that were scraped from Twitter'

Keywords: 'Twitter, Sentiment, Bitcoin, Crypto, Cryptocurrency, Scrapeing'

Author: 'Mihai Atimut, Sandor Lukacs, Arpad Gerber'

Submitted: '26 December 2020'

Input: 'The input is raw tweets. The user can choose to scrape or to use data thata was 
downoalded in advance (sample data)'

Output: 'Cross-correlation plots, scagnostics plots, sentiment graph'

```

![Picture1](1.BTC_prices_in_USD.png)

![Picture2](2.Sentiment_scores_for_each_minute.png)

![Picture3](3.Cross-correlation_between_sentiments_and_various_lags.png)

![Picture4](4.Cross-correlation_between_sentiments_and_various_lags_(derivatives).png)

![Picture5](5.Scagnostic_plot_for_data.png)

![Picture6](6.Scagnostic_plot_for_data_(derivative).png)
...
automatically created on 2020-12-30